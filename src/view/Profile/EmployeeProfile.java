...
import view.Parking.ParkingCheck;
import view.Update.EmployeeInfo;
import view.WorkingSchedule.EmployeeWorking;
...
public class EmployeeProfile extends JFrame {
    ...
    public EmployeeProfile(){
        ...
        this.employee=employeeController.fetchLoggedInEmployee();

        label = new JLabel("EMPLOYEE PROFILE");
        ...
        name1 = new JLabel("Sanjeela Thapa");
        ...
        email1= new JLabel("sanjeela@123");
        ...
        designation1 = new JLabel("EMPLOYEE");
        ...
        guest.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ParkingCheck parkingCheck = new ParkingCheck();
                parkingCheck.show();
                dispose();
            }
        });
